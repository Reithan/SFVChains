...
struct Ibuki : public iCharacter {
	Ibuki() : iCharacter() {
		...
		_moves.push_back(MoveData("crouch HK"						,8  ,-12	,MoveData::kFAC_KnockDown | 67	,5	,84,	100,	150, MoveData::kMVT_Basic | MoveData::kMVT_HardKnockDown, MoveData::kMVT_VT));
		...
		_moves.push_back(MoveData("TC 5MK 2HK"						,5  ,-12	,MoveData::kFAC_KnockDown | 68	,0	,80	,60	,60	,MoveData::kMVT_Basic | MoveData::kMVT_HardKnockDown, MoveData::kMVT_VT));
		_moves.push_back(MoveData("TC 5MK 2HK 5HK"					,5	,MoveData::kFAC_Whiff,	MoveData::kFAC_Reset | MoveData::kFAC_KnockDown | 17,0,	28,	40,	60, MoveData::kMVT_TargetCombo | MoveData::kMVT_Basic, MoveData::kMVT_VT));
		...
		_moves.push_back(MoveData("THROW"							,5	,MoveData::kFAC_KnockDown | 64	,	MoveData::kFAC_KnockDown | 64,	0,	0,	120,	170	, MoveData::kMVT_Throw, NULL));
		_moves.push_back(MoveData("THROW BACK"						,5	,MoveData::kFAC_KnockDown | 78	,	MoveData::kFAC_KnockDown | 78,	0,	0,	130,	170	, MoveData::kMVT_Throw, NULL));
		_moves.push_back(MoveData("THROW AIR"						,5	,MoveData::kFAC_KnockDown | 110,	MoveData::kFAC_KnockDown | 110,	0,	0,	140,	150	, MoveData::kMVT_AirThrow, NULL));
		_moves.push_back(MoveData("VT"								,1	,0	,0	,0	,0	,100	,100, MoveData::kMVT_VT, NULL));
		_moves.push_back(MoveData("VS"								,15	,-5	,MoveData::kFAC_KnockDown | 85,	0,	0,	60,	100	, MoveData::kMVT_VS | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("VS HOLD"							,25	,-2, MoveData::kFAC_KnockDown | 87,	0,	0,	80, 150	, MoveData::kMVT_VS | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("VR"								,15 ,-2, MoveData::kFAC_KnockDown | 88,	0,	0,	60,	0	, MoveData::kMVT_VS, NULL));
		...
		_moves.push_back(MoveData("Kazekiri LK"						,3  ,-27,	MoveData::kFAC_KnockDown | 81,	0,	0,	120,	150, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, MoveData::kMVT_CA));
		_moves.push_back(MoveData("Kazekiri MK"						,4  ,-27,	MoveData::kFAC_KnockDown | 81,	0,	0,	120,	150, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, MoveData::kMVT_CA));
		_moves.push_back(MoveData("Kazekiri HK"						,5  ,-27,	MoveData::kFAC_KnockDown | 81,	0,	0,	120,	150, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, MoveData::kMVT_CA));
		_moves.push_back(MoveData("Kazekiri EX"						,4  ,-27,	MoveData::kFAC_KnockDown | 85,	0,	0,	120,	150, MoveData::kMVT_Special | MoveData::kMVT_EX | MoveData::kMVT_KnockBack, MoveData::kMVT_CA | MoveData::kMVT_Air));
		_moves.push_back(MoveData("Raida LP"						,7  ,-12,	MoveData::kFAC_KnockDown | 79,	0,	0,	100,	200, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Raida MP"						,7  ,-12,	MoveData::kFAC_KnockDown | 77,	0,	0,	110,	200, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Raida HP"						,7  ,-12,	MoveData::kFAC_KnockDown | 79,	0,	0,	120,	200, MoveData::kMVT_Special | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Raida EX"						,7  ,-11,	MoveData::kFAC_KnockDown | 79,	0,	0,	150,	200, MoveData::kMVT_Special | MoveData::kMVT_EX | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Kunai P"						,7	,-2,	2,	8, 11, 40	,50	, MoveData::kMVT_Special, MoveData::kMVT_CA));
		_moves.push_back(MoveData("Kunai EX"						,7	,18,	MoveData::kFAC_KnockDown | 110,	18, 110, 60	,100, MoveData::kMVT_Special | MoveData::kMVT_EX | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Airborne Kunai P"				,7	,13,	17,	0,	0,	40,	50	, MoveData::kMVT_Special | MoveData::kMVT_Air, NULL));
		_moves.push_back(MoveData("Airborne Kunai EX"				,7	,24,	MoveData::kFAC_KnockDown | 22,	0,	0,	70,	100	, MoveData::kMVT_Special | MoveData::kMVT_Air | MoveData::kMVT_KnockBack, NULL));
		_moves.push_back(MoveData("Kunai Ikkinage P"				,11	,9	,MoveData::kFAC_KnockDown | 110,	0,	0,	150,	150	, MoveData::kMVT_Special, MoveData::kMVT_CA));
		_moves.push_back(MoveData("Airborne Kunai Ikkinage K"		,16	,0	,MoveData::kFAC_KnockDown | 0,	0,	0,	150,	150	, MoveData::kMVT_Special | MoveData::kMVT_Air, NULL));
		...
		_moves.push_back(MoveData("Critical Art - Kachofugetsu"		,5	,20		,MoveData::kFAC_KnockDown | 110, 0, 0, 350, 0, MoveData::kMVT_CA | MoveData::kMVT_HardKnockDown | MoveData::kMVT_KnockBack, NULL));
	}
